/* ============================================
   LUCIUS â€” Podcast Script Generator
   ============================================ */
...
(function () {
    ...
    async function transformText() {
        ...
        const lengthGuide = {
            brief: 'Keep it tight â€” around 150-300 words (1-2 minutes). Only expand on the most important points. Do NOT pad or add filler.',
        ...
        const styleGuide = {
            conversational: 'warm, casual, and conversational â€” like chatting with a friend over coffee. Use "you" and "we" freely.',
            professional: 'polished and authoritative â€” like a news anchor or professional broadcaster. Clear, structured, confident.',
            storytelling: 'narrative and immersive â€” draw the listener in with vivid language, pacing, and a story arc.',
            educational: 'clear and informative â€” break down concepts step by step, use analogies, make complex ideas accessible.',
        };
...
The raw input is approximately ${wordCount} words. Stay proportional â€” do NOT inflate short notes into long scripts. If the input is brief, the output should be brief. Only expand where it genuinely adds value.

Rules:
- Write a natural-sounding intro that hooks the listener â€” keep it short, not a full paragraph
- Organize the content with smooth transitions
- End with a brief, memorable closing â€” one or two sentences, not a long sign-off
- Do NOT include stage directions, speaker labels, or formatting markers
- Write it exactly as it should be spoken aloud â€” every word on the page is a word the host says
...
${raw}`;
    ...
    function saveEpisode() {
        ...
        $('#saveEpisodeBtn').textContent = 'Saved âœ“';
    ...
    async function transformText() {
        ...
        const lengthGuide = {
            short: 'around 300-500 words (2-3 minutes when read aloud)',
            medium: 'around 700-1000 words (5-7 minutes when read aloud)',
            long: 'around 1500-2000 words (10-15 minutes when read aloud)',
        };
...
Rules:
- Write a natural-sounding intro that hooks the listener
- Organize the content with smooth transitions
